...
function updateRate(currency) {
    const buyInput = document.querySelector(`input[data-currency="${currency}"][data-type="buy"]`);
    const sellInput = document.querySelector(`input[data-currency="${currency}"][data-type="sell"]`);
